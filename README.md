...
#### Mod_Admin_Plus V26.09.04 Beta5 2026/09/04
	...
	- Se crea la tabla intermedia $table_name_js = "`".$_SESSION['clave']."jornadas_users`";
...
----
#### Mod_Admin_Plus V26.08.29 Beta 2026/08/29
	- Se realiza una copia de seguridad de los archivos de usuarios y bbdd para reinstalación...
	- Adaptar function ayear() importa config/ConfigYear.php...
	...
	- fichar/Reg_Fichar_Ver.php Modificar select usuarios...
	- fichar/Reg_Fichar_Ver.php fichar\Inc_Show_Form_tot.php Modificar select year...
	- Balances/Balances.php Modificar select year...
	- Se crea config/SelectAnhos.php para generar select anual mediante consulta a schemas...

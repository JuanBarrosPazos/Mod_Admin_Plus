...
<img src='../Users/".$_SESSION['sref']."/img_admin/".$_SESSION['smyimg']."' height='120px' width='90px' />
			...
			<tr align='center'>
				<td colspan=2>
			<span id='file_name'>SELECCIONE UNA IMAGEN</span>
				</td>
			</tr>
			<tr align='center' height=30px>
				<td colspan=2>
	<form name='form_datos' method='post' action='$_SERVER[PHP_SELF]' enctype='multipart/form-data' style='display:inline-block;float:left;'>
		<input type='file' name='myimg' id='myimg' value='".$defaults['myimg']."' class='inputfile custom' />
			...
			<button type='submit' title='MODIFICAR IMAGEN' class='botonverde imgButIco SaveBlack' style='vertical-align:top;float:right;' ></button>
				<input type='hidden' name='imagenmodif' value=1 />
		</form>
		<form name='closewindow' action='$_SERVER[PHP_SELF]'  onsubmit='window.close()' style='display:inlin-block; float:right;'>
			<button type='submit' title='CERRAR VENTANA' class='botonrojo imgButIco CancelBlack' style='vertical-align:top;' ></button>
				<input type='hidden' name='oculto2' value=1 />
		</form>
				</td>
